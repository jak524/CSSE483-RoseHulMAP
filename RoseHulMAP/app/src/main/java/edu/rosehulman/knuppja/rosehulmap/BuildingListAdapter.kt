...
class BuildingListAdapter(var context: Context?, var listener: BuildingListFragment.OnPicSelectedListener?, var fm: FragmentManager) : RecyclerView.Adapter<BuildingViewHolder>() {

    var buildings = ArrayList<Building>()
    private val picsRef = FirebaseFirestore.getInstance().collection("buildings")
...
//    }
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): BuildingViewHolder {
        ...
        return BuildingViewHolder(view, this)
    }
